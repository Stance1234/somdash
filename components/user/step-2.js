function Step2() {
	return (
		<section className='app-gr-5 py-10'>
			<div className='app-py-3'>
				<svg className='w-5 h-5 fill-slate-300' version='1.1' id='Layer_1' x='0px' y='0px' viewBox='0 0 475 475'>
					<g>
						<g>
							<g>
				...
				<h3 className='text-center'>Fund your Trading Account and start earning!</h3>
				<br />
				<div className='text-center'>
					<p className='text-center'>
						You can fund an account right after registration. By funding a trading account, you can get the additional funds
						as a bonus. By investing more, your bonus can be even doubled!
					</p>
				</div>
			</div>
		</section>
