		...
		<div className='white pt5 css-1wwdn0x'>
							...
							<div className>
								...
								<div className='l-newsletterForm'>
									...
									<div className='silver lh-copy f7'>
										We&apos;re committed to your privacy. Growthpoint Invest Ltd Inc Broker uses the information you provide to us
					...
					<div className='cf nmh2'>
						<div className='fl ph2 w-50'>
							...
							<a
								...
								href='mailto:support@growthpointinvestld.com'>
								support@growthpointinvestld.com
							</a>
							...
							<div className='flex justify-center tc center'>
								<div className='mr2'>
									<a
										...
										href='https://blog.dashboard.growthpointinvestld.com/'
								...
								<div className='mr2'>
									<a href='https://twitter.com/growthpointinvestld' target='_BLANK' rel='noopener noreferrer'>
								...
								<div className='mr2'>
									<a href='https://www.linkedin.com/company/growthpointinvestld-inc' target='_BLANK' rel='noopener noreferrer'>
										<svg viewBox='0 0 64 64' width={25} height={25}>
			...
			<div className='center ph4 mw8-5 w-100 dn db-l'>
					...
					<div className='fl ph4 w-100 w-50-l'>
						<div className='measure-wide'>
							...
							<div className='l-newsletterForm'>
								...
								<div className='silver lh-copy f7'>
									We&apos;re committed to your privacy. Growthpoint Invest Ltd uses the information you provide to us to contact
				...
				<div className='cf nmh4 mb4'>
					...
					<div className='fl ph4 w-100 w-25-l'>
						...
						<a className='fw6 white-80 hover-color-[#0018A8] no-underline db pv1 pointer mb2' href='mailto:sales@growthpointinvestldbroker.com'>
							sales@growthpointinvestldbroker.com
						</a>
			...
			<div className='center ph4 mw8-5 w-100 pt2'>
				<div className='silver f7 pb5 pt4 lh-copy'>
					©2023 Growthpoint Invest Ltd Inc Broker. All rights reserved.
					<br />
					<br />
					No legal, tax, investment, or other advice is provided by any Growthpoint Invest Ltd Inc Broker entity. Please consult your
