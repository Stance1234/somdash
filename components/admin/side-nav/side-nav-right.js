...
function AdminSideNavRight() {
    return (
        // <!-- Sidebar -->
			<div className="sidebar sidebar-right sidebar-animate">
				<div className="sidebar-icon">
					<a href="#" className="text-right float-right text-dark fs-20" data-toggle="sidebar-right" data-target=".sidebar-right"><i className="fe fe-x"></i></a>
				</div>
				<div className="sidebar-body">
					...
					<div className="d-flex p-3 border-top">
						<label className="ckbox"><input checked type="checkbox"/><span>System Updated</span></label>
						<span className="ml-auto">
							<i className="fe fe-edit-2 text-primary mr-2" data-toggle="tooltip" title="" data-placement="top" data-original-title="Edit"></i>
							<i className="fe fe-trash-2 text-danger mr-2" data-toggle="tooltip" title="" data-placement="top" data-original-title="Delete"></i>
						</span>
...
export default AdminSideNavRight