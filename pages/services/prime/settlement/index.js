		...
		<UserLayout>
			<div className='b-rootLayout relative css-179ecci'>
				...
				<div className='bg-franc-2 pt5 pt6-l pb1 mb5 mb6-l relative overflow-hidden'>
					<div className='center ph4 mw8-5 w-100 overflow-hidden mb5 mb5-m mb6-l relative'>
						<div className='dn-l mv4 nmh5'>
							<img alt='' className='react-reveal ml5 shadow-4 br2 overflow-hidden' style={{ opacity: 1 }} />
						</div>
				...
				<div className='relative mb5 mb6-l'>
					<div className='center ph4 mw8-5 w-100'>
						<div className='cf nmh4 flex-l'>
							...
							<div className='fl ph4 w-100 w-50-l dn flex-l flex-column items-center justify-center'>
								<div className='tc'>
									<div className='flex mb3'>
										<div className='flex flex-column justify-between'>
											<div className='pa3 ba b--border mh2 mb3'>
												<h6 className='f6 fw6 lh-title black-70'>OTCs</h6>
											</div>
											<img
												src='data:image/svg+xml;base64,'
												className='l-marketingIcon'
												alt=''
											/>
										</div>
										<div className='flex flex-column justify-between'>
											<div className='pa3 ba b--border mh2 mb3'>
												<h6 className='f6 fw6 lh-title black-70'>Single Dealer Platforms</h6>
											</div>
											<img
												src='data:image/svg+xml;base64,'
												className='l-marketingIcon'
										...
										<div className='flex flex-column justify-between'>
											<div className='pa3 ba b--border mh2 mb3'>
												<h6 className='f6 fw6 lh-title black-70'>Exchanges</h6>
											</div>
											<img
												src='data:image/svg+xml;base64,'
												className='l-marketingIcon'
										...
										<div className='flex flex-column justify-between'>
											<div className='pa3 ba b--border mh2 mb3'>
												<h6 className='f6 fw6 lh-title black-70'>Smart Order Routing</h6>
											</div>
											<img
												src='data:image/svg+xml;base64,'
												className='l-marketingIcon'
										...
										<div className='flex flex-column justify-between'>
											<div className='pa3 ba b--border mh2 mb3'>
												<h6 className='f6 fw6 lh-title black-70'>3rd Party Platform (OMS/EMS)</h6>
											</div>
											<img
												src='data:image/svg+xml;base64,'
												className='l-marketingIcon'
										...
										<div className='flex flex-column justify-between'>
											<div className='pa3 ba b--border mh2 mb3'>
												<h6 className='f6 fw6 lh-title black-70'>Asset Managers</h6>
											</div>
											<img
												src='data:image/svg+xml;base64,'
												className='l-marketingIcon'
									...
									<div className='mb3 ba b--border pa3'>
										<div className='flex mb3'>
											<div className='pa3 ba b--border mh2 w-50'>
												<h6 className='f6 fw6 lh-title black-70 [#0018A8]'>Settlement REST API</h6>
											</div>
											<div className='pa3 ba b--border mh2 w-50'>
												<h6 className='f6 fw6 lh-title black-70 [#0018A8]'>Web interface</h6>
											</div>
										</div>
				...
				<div className='relative mb5 mb6-l'>
					<div className='center ph4 mw8-5 w-100'>
						<div className='cf nmh4 flex-l'>
							<div className='fl ph4 w-100 w-50-l dn flex-l flex-column items-center justify-center mb4 mb0-ns'>
								<div className='flex'>
									<div className='tr mh3'>
										...
										/>
										<div className='ttu fw4 lh-title tracked-mega o-60 f7 mb2'>Cold Storage</div>
										<h5 className='f6 f5-m f5-l fw5 lh-title black-90 mb2'>Seller</h5>
									</div>
									<div className='ma3 css-drs3vf' />
									<div>
										<img
											className='mh3 css-1jsohtw'
											src='data:image/svg+xml;base64,'
										/>
									</div>
									<div className='ma3 css-drs3vf' />
									<div className='mh3'>
										...
										/>
										<div className='ttu fw4 lh-title tracked-mega o-60 f7 mb2'>Cold Storage</div>
										<h5 className='f6 f5-m f5-l fw5 lh-title black-90 mb2'>Buyer</h5>
									</div>
								</div>
							</div>
							<div className='fl ph4 w-100 flex-l items-center justify-center w-50-l'>
