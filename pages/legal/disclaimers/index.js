					...
					<div className='center ph4 mw8-5 w-100 mb6'>
								...
								<div className='bp3-tab-list' role='tablist'>
									...
									<div
										...
										<Link href='/legal/services-agreement-addendum'>
											<a className='fw6 black-80 hover-color-[#0018A8] no-underline db pv1 pointer'>
												General Addendum to Growthpoint Invest Ltd Inc. Broker Services Agreement (EN)
											</a>
										</Link>
									</div>
								</div>
						...
						<div className='cf nmh4 flex-l'>
							...
							<div className='fl ph4 w-100 w-80-l'>
								<h3 className='f4 f3-m f3-l fw6 lh-title tracked-condensed mb3'>Growthpoint Invest Ltd Inc. Broker Disclaimers</h3>
								...
								<p className='lh-copy mb4 measure-wide2'>
									Custody services are offered to eligible participants through Growthpoint Invest Ltd Trust Company, Inc., a trust
									company chartered in South Dakota and Growthpoint Invest Ltd Inc. Broker New York Trust Company LLC, a limited purpose
									trust company in New York. Growthpoint Invest Ltd Inc. Broker Portfolio and Growthpoint Invest Ltd Inc. Broker Tax are software solutions
									offered through growthpointinvestld, Inc. Digital asset trading is done with Growthpoint Invest Ltd Prime LLC as the
									counterparty to all trades, with trading settlement services provided by Growthpoint Invest Ltd Inc. Broker Trust
									Company, Inc. Institutional digital asset lending services are provided by Growthpoint Invest Ltd Inc. Broker Prime
									LLC, and are not FDIC insured. Growthpoint Invest Ltd Inc. Broker Trust Company, Inc., Growthpoint Invest Ltd Inc. Broker New York Trust
									Company LLC, growthpointinvestld, Inc., and Growthpoint Invest Ltd Inc. Broker Prime LLC are separately operated, wholly-owned
									subsidiaries of Growthpoint Invest Ltd Inc. Broker Holdings, Inc., a Delaware corporation headquartered in Palo Alto,
									CA.
								</p>
								<h4 className='f4-ns f5 fw6 lh-title tracked-condensed mb3-l mb2'>Growthpoint Invest Ltd Inc. Broker Inc.</h4>
								<p className='lh-copy mb4 measure-wide2'>
									Digital assets software solutions provided by Growthpoint Invest Ltd Inc. Broker Inc., a separately operated,
									wholly-owned subsidiary of Growthpoint Invest Ltd Inc. Broker Holdings, Inc.
								</p>
								<h4 className='f4-ns f5 fw6 lh-title tracked-condensed mb3-l mb2'>Growthpoint Invest Ltd Inc. Broker Trust Company</h4>
								<p className='lh-copy mb4 measure-wide2'>
									Custody services are offered to eligible participants through Growthpoint Invest Ltd Trust Company, a trust
									company chartered in both South Dakota and Growthpoint Invest Ltd Inc. Broker New York Trust Company LLC, a limited
									purpose trust company in New York. Growthpoint Invest Ltd Inc. Broker Trust Company, Inc. and Growthpoint Invest Ltd Inc. Broker New York
									Trust Company LLC are not engaged in the offer, sale, trading, or lending of securities or
									digital assets. Growthpoint Invest Ltd Inc. Broker Trust Company, Inc. and Growthpoint Invest Ltd New York Trust Company LLC are
									separately operated, wholly-owned subsidiaries of Growthpoint Invest Ltd Inc. Broker Holdings, Inc.
								</p>
								<h4 className='f4-ns f5 fw6 lh-title tracked-condensed mb3-l mb2'>Growthpoint Invest Ltd Inc. Broker Prime LLC</h4>
								<p className='lh-copy mb4 measure-wide2'>
									Growthpoint Invest Ltd Inc. Broker Prime LLC is not engaged in the offer, sale, trading, or lending of securities.
									Institutional digital asset lending services are provided by Growthpoint Invest Ltd Inc. Broker Prime LLC, a
									separately operated, wholly-owned subsidiary of Growthpoint Invest Ltd Inc. Broker Holdings, Inc.
								</p>
								<h4 className='f4-ns f5 fw6 lh-title tracked-condensed mb3-l mb2'>Growthpoint Invest Ltd Inc. Broker Holdings LLC</h4>
								<p className='lh-copy mb4 measure-wide2'>
									Growthpoint Invest Ltd Inc. Broker Holdings LLC is not engaged in the business of the offer, sale or trading of
									securities. Growthpoint Invest Ltd Inc. Broker Holdings, Inc. is a Delaware corporation headquartered in Palo Alto,
									CA.
								</p>
								<p className='lh-copy mb4 measure-wide2'>
									None of these Growthpoint Invest Ltd Inc. Broker entities are registered with the U.S. Securities and Exchange (SEC),
									...
									is provided by any Growthpoint Invest Ltd Inc. Broker entity. Please consult your legal/tax/investment professional
								...
								<p className='lh-copy mb4 measure-wide2'>
									...
									<br />
									<br />
									Growthpoint Invest Ltd Inc. Broker New York Trust Company LLC is chartered as a limited purpose trust company and
									licensed to engage in Virtual Currency Business Activity by the New York State Department of
									Financial Services. If you have any questions or complaints, please first contact Growthpoint Invest Ltd support
									at support@growthpointinvestld.com or by phone at 1 (650) 542-0730, or by mailing to: Growthpoint Invest Ltd Inc. Broker Support,
									2446 Ash Street, Palo Alto, CA 94306.
									<br />
									<br />
									If you are a customer of Growthpoint Invest Ltd Inc. Broker New York Trust Company LLC, you may also direct unresolved
