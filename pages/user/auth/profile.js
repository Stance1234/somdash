				...
				<div className='row pb-10'>
					<div className='col l6 s12 offset-l3'>
						<ul className='collection rounded-lg shadow-sm bg-white'>
							...
							<CopyToClipboard
								text={`https://www.dashboard.growthpointinvestld.com/signup?ref=${profile.refferal_code}`}
								...
								<li
									...
									<span className='font-semibold text-blue-600'>
										{`https://www.dashboard.growthpointinvestld.com/signup?ref=${profile.refferal_code}`}
									</span>
								</li>
							</CopyToClipboard>
						</ul>
