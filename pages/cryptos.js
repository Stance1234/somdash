...
function Cryptos() {
	return (
		<UserLayout>
			<Head>
				<title>Trade Top Cryptocurrencies - Growthpoint Invest Ltd Inc. Broker </title>
			</Head>
			...
			<div className='container fade-appear-done fade-enter-done'>
				<br />
				<h3>Build Your Cryptocurrency Trading Portfolio with Growthpoint Invest Ltd Inc. Broker </h3>
				<p>
					Growthpoint Invest Ltd Inc. Broker is excited to announce the launch of our new cryptocurrency trading platform. Now you can start trading Bitcoin,
