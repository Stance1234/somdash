...
function MiningHelp() {
	return (
		<UserLayout>
			<Head>
				<title>Mining Help - growthpointinvestld</title>
			</Head>
									...
									<ul className='collapsible'>
										<li>
											<div className='collapsible-header' tabIndex='0'>
												...
												How does Bitcoin mining work with growthpointinvestld
											</div>
										...
										<li>
											...
											<div className='collapsible-body'>
												<span>
													...
													<br />
													<p>
														(*) “Growthpoint Invest Ltd Broker Advanced Allocation” (special feature): It allows you
											...
											<div className='collapsible-body'>
												<span>
													...
													<p>
														...
														and not related to Growthpoint Invest Ltd Broker in any manner.
													</p>
												</span>
											</div>
										</li>
											...
											<div className='collapsible-body'>
												<span>
													...
													<p>
														...
														Growthpoint Invest Ltd Broker you have a guaranteed uptime of 100%: in case one of your
										...
										<li>
											...
											<div className='collapsible-body'>
												<span>
													<span>
														<p>
															Growthpoint Invest Ltd Broker allows its clients to mine different types of coins at
														...
														<p>
															...
															cryptocurrency. The Growthpoint Invest Ltd Broker Advanced Auto-Allocation (in short
														...
														<p>
															...
															wallet address(es) to your Growthpoint Invest Ltd Broker profile. Find out more
						...
						<div id='account' className='active' style={{ display: "block" }}>
							<ul className='collapsible'>
								...
								<li>
									...
									<div className='collapsible-body'>
										<span>
											...
											Growthpoint Invest Ltd Broker account, or else we won&apos;t be able to help you.
										</span>
									</div>
								</li>
								<li>
								...
								<li>
									...
									<div className='collapsible-body'>
										<span>
											To create a Growthpoint Invest Ltd Broker account, simply click on SIGN UP, enter your e-mail address and a
											...
											you into your Growthpoint Invest Ltd Broker account. *In case you did not receive a verification e-mail,
											please also check your Junk/Spam folder. If you cannot find the e-mail in any of the
											folders, please go to the Growthpoint Invest Ltd Broker &apos;Login&apos; page, enter the needed info to log
								...
								<li>
									...
									<div className='collapsible-body'>
										<span>
											...
											the Growthpoint Invest Ltd Broker family, please contact our customer service using your primary e-mail
								...
								<li>
									...
									<div className='collapsible-body'>
										<span>
											...
											or the “Contact Customer Service” section on your Growthpoint Invest Ltd Broker account.
										</span>
									</div>
								</li>
								<li>
