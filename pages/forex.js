...
function AboutUs() {
	return (
		<UserLayout>
			<Head>
				<title>Trade Forex - growthpointinvestld</title>
			</Head>
			<div style={{ paddingBottom: "6rem", paddingTop: "2rem" }} className='fade-appear-done fade-enter-done'>
				...
				<p className='app-relative center'>Trade forex on the Growthpoint Invest Ltd Inc. Broker platform and enjoy reliable pricing and exceptional execution</p>
			</div>
