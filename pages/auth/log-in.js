			...
			<div id='app' className='flex'>
				<div
					...
					<div className='react-reveal pv4-5 ph4 ph4-5-l center-l relative'>
						...
						<div className='f5 f5-m f4-l lh-copy mb3'>to continue to growthpointinvestld</div>
						...
						<div className='flex justify-between mb3 mt4-5 mt4-5-l f7 silver'>
							<div className='flex justify-between flex-column flex-row-ns flex-grow-1 bt b--border pt3 mb4'>
								...
								<div className='flex'>
									<a className='[#0018A8] fw5' href='https://www.dashboard.growthpointinvestld.com/terms' target='_BLANK' rel='noreferrer'>
										Terms
									</a>
									<a
										className='ml3 [#0018A8] fw5'
										href='https://www.dashboard.growthpointinvestld.com/privacy'
										target='_BLANK'
										rel='noreferrer'>
										Privacy
									</a>
